...
class SurahChipRow extends StatelessWidget {
  ...
  static const List<_SurahChipConfig> chips = [
    (surahNumber: 2, ayahId: 255, malayalamFallbackLabel: 'ആയത്തുൽ കുർസി'),
    ...
    (surahNumber: 18, ayahId: null, malayalamFallbackLabel: 'അൽ കഹ്ഫ്'),
    (surahNumber: 75, ayahId: null, malayalamFallbackLabel: 'അൽ ഖിയാമ'),
  ];
  ...
  static String _chipLabel({
    ...
    if (isMalayalam && chip.malayalamFallbackLabel != null) {
      final hasMalayalamName =
          surah != null && surah.malayalamName.trim().isNotEmpty;
      if (!hasMalayalamName) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => SurahScreen(scrollToAyahId: chip.ayahId),
                  ),
                );
              },
              child: Container(
